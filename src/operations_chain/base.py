...
class BaseOperation(ABC):
    ...
    def _get_execution_metadata(self, input_value: Any, output_value: Any) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            'output_type': type(output_value).__name__ if output_value is not None else 'None',
            'config': self.config
        }
